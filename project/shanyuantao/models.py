...
class HousePrice(models.Model):
    house_price = models.CharField(max_length=128, null=True)
...
class House(models.Model):
    ...
    house_price = models.IntegerField(blank=True, null=True, db_column='price')
    address = models.CharField(max_length=512, blank=True, null=True)
    house_acreage = models.IntegerField(blank=True, null=True, db_column='acreage')
    index_img_url = models.CharField(max_length=1024, blank=True, null=True)

    price = models.ForeignKey(HousePrice)
    acreage = models.ForeignKey(Acreage)
